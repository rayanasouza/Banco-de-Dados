...
insert into medicos (nroa, andar, capacidade) values (1, 3, 1);
insert into medicos (nroa, andar, capacidade) values (2, 4, 2);
insert into medicos (nroa, andar, capacidade) values (3, 5, 6);
insert into medicos (nroa, andar, capacidade) values (4, 2, 2);
insert into medicos (nroa, andar, capacidade) values (5, 1, 3);
